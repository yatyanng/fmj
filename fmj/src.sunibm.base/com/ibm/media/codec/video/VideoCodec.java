...
public abstract class VideoCodec extends BasicCodec {
	...
	public boolean checkFormat(Format format) {
		...
		if (TRACE)
			logger.fine("videoCodec.checkFormat(" + LoggingStringUtils.formatToStr(format) + ")");
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		// this.
		if (TRACE)
			logger.fine("videoCodec.getMatchingOutputFormats(" + LoggingStringUtils.formatToStr(in) + ")");
															...
															// getMatchingOutputFormats
	{
		...
		if (TRACE)
			logger.fine("videoCodec.getSupportedOutputFormats(" + LoggingStringUtils.formatToStr(in) + ")");
		// TODO: test this code.
												...
												// overridden
	{
		...
		if (TRACE)
			logger.fine("videoCodec.setInputFormat(" + LoggingStringUtils.formatToStr(format) + ")");
	...
	@Override
	protected void updateOutput(Buffer outputBuffer, Format format, int length, int offset) { // TODO - does this call
																								// checkFormat?
		if (TRACE)
			logger.fine("videoCodec.updateOutput(" + outputBuffer + ", " + LoggingStringUtils.formatToStr(format) + ", "
					+ length + ", " + offset + ")");
		// seems to be called for every frame
