...
public class SourcedTimerEvent extends EventObject {
	 ...
	 *
	 * @param t   Time in units of source.
	 */
	...
	/**
	 * Set the time of event object. This operation for a client unless it happens
	 * to re-generated event for its own purposes.
	 *
	 * @param t Time in units detemined by caller.
	 */
