...
public class Utility {
	 ...
	 * URL. If not successful, assumes arg is a file and tries to create a file URL
	 * using the full path name of the specified file. The return value of this
	 * routine should be checked to ensure that a URL was successfully created.
	 *
	 * @param arg the url string to convert
	...
	/**
	 * Given a File object, return a String representing the file's extension. If
	 * there is no extension, return null.
	 *
	 * @param f A java.io.File object
	 ...
	 * <p>
	 * All Controllers must be at least in the Realized state. If a Controller is
	 * not in the realized state, its value is ignored.
	 * <p>
	 * If all Controllers report LATENCY_UNKNOWN, return LATENCY_UNKNOWN and let the
	 * caller worry about what to do.
	 * <p>
	 *
	 * @param controllers An array of javax.media.Controller objects all at least
	 *                    realized.
	 *                    <p>
	...
	/**
	 * Pick a master Player for an array of Players. Return first Player that has a
	 * gain control. If no Player has a gain control, return 0.
	 *
