...
public class SourcedTimer implements ActionListener {
	 ...
	 *
	 * @param src An object that implements the TimeSource interface.
	 */
	 ...
	 *
	 * @param src         An object that implements the TimeSource interface.
	 * @param granularity Periood in milliseconds that base timer should fire.
	 */
	 ...
	 *
	 * @param src   An object that implements the TimeSource interface.
	 * @param timer A java.swing.Timer object for use as base timer.
	 */
	 ...
	 *
	 * @param e ActionEvent from base timer.
	 */
	@Override
	 ...
	 *
	 * @param l An object that implements SourcedTimerListener interface.
	 */
	...
	/**
	 * A client of SourcedTimer may need to convert source timer time from raw units
	 * to some other units for display purposes. This method is available to
	 * listeners who have a reference to a SourcedTimer but not necessarily the
	 * source itself. It simply delegates to the source and asks what number are raw
	 * units divider by to arrive at seconds.
	 *
	 *
	 * @return A number used to divide base timer time for conversion to seconds.
	 */
	 ...
	 *
	 * @param nsecs Time in nanoseconds from base timer.
	 */
	...
	/**
	 * Start the timer. The associated base timer is started if it is not already
	 * running.
	 *
	 */
	public void start() {
