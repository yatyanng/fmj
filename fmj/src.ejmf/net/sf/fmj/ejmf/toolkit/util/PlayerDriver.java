...
public abstract class PlayerDriver extends JApplet {
	...
	/**
	 * Should be called by the real main() once a PlayerDriver has been constructed
	...
	/**
	 * This method is called by browser when page is left. Player must close or else
	 * it will continue to render even after having left the page. This can be an
	 * issue with audio.
	 */
	@Override
	public void destroy() {
