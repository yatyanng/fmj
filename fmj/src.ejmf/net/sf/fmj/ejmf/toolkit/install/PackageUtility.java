...
public class PackageUtility {
	/**
	 * Adds a content prefix to the JMF content prefix list. If the content prefix
	 * already exists in the list, no action is taken. The new content prefix list
	 * will only be valid during the current session.
	 *
	 * @param prefix the content prefix to add
	 */
	...
	/**
	 * Adds a content prefix to the JMF content prefix list. If the content prefix
	 * already exists in the list, no action is taken. If commit is true, the list
	 * will be commited and become persistent over future JMF sessions. Otherwise,
	 * the new content prefix list will only be valid during the current session.
	 *
	 * @param prefix the content prefix to add
	 * @param commit boolean indicating whether to make new content list persistent
	 */
	 ...
	 *
	 * @param prefix the protocol prefix to add
	 */
	...
	/**
	 * Adds a protocol prefix to the JMF protocol prefix list. If the protocol
	 * prefix already exists in the list, no action is taken. If commit is true, the
	 * list will be commited and become persistent over future JMF sessions.
	 * Otherwise, the new protocol prefix list will only be valid during the current
	 * session.
	 *
	 * @param prefix the protocol prefix to add
	 * @param commit boolean indicating whether to make new protocol list persistent
	 */
	 ...
	 * prefix does not exist in the list, no action is taken. The new content prefix
	 * list will only be valid during the current session.
	 *
	 * @param prefix the content prefix to remove
	 */
	...
	/**
	 * Removes a content prefix from the JMF content prefix list. If the content
	 * prefix does not exist in the list, no action is taken. If commit is true, the
	 * list will be commited and become persistent over future JMF sessions.
	 * Otherwise, the new content prefix list will only be valid during the current
	 * session.
	 *
	 * @param prefix the content prefix to remove
	 * @param commit boolean indicating whether to make new content list persistent
	...
	/**
	 * Removes a protocol prefix from the JMF protocol prefix list. If the protocol
	 * prefix does not exist in the list, no action is taken. The new protocol
	 * prefix list will only be valid during the current session.
	 *
	 * @param prefix the protocol prefix to remove
	 */
