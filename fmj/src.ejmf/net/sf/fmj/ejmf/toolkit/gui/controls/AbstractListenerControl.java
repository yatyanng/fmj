...
public abstract class AbstractListenerControl implements Control {
	...
	/**
	 * Since different controls may have different types of listeners, each subclass
	 * should define addControlListener to register the correct type of listener
	 * with component.
	 *
	...
	/**
	 * Subclasses defined this method to supply their GUI component. Subclasses must
	 * not return a null component.
	 * <p>
	...
	/**
	 * Subclasses of AbstractListenerControl must define this method to supply an
	 * EventListener to handle events originating from control's component.
	 * <p>
	...
	/**
	 * Initializes listener, establishes it as default and registers it with Control
	 * Compoent.
	 *
	...
	/**
	 * Since different controls may have different types of listeners, each subclass
	 * should define removeControlListener to remove listener from component
	 * listener list in a type-safe way.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException is thrown if attempt is made to set
	...
	/**
	 * Subclasses override and provide the guts to setControllerHook if they want to
	 * augment the the work of setController.
	 *
	 * @param controller Controller with which this control is associated.
	 */
	...
	/**
	 * @return fully-qualified class name. This value can be used as search key in
	 *         response to Controller.getControl(name)
	 */
	@Override
