...
public class TimeDisplayControl implements Control, SourcedTimerListener, TimeSource, ControllerListener {
	/*
	 ...
	 *
	 * @param controller The Controller with which to associate control.
	 */
	 ...
	 * Controller passed as an argument.
	 * <p>
	 * The <tt>timer</tt> is used as the SourcedTimer. This form of the constructor
	 * allows reuse of an existing SourcedTimer.
	 *
	 ...
	 *
	 * @param e A controller event used to determine start/stop state of timer.
	 */
	@Override
	 ...
	 * format.
	 *
	 * @param longTime time in unit such that <tt>longTime/d</tt> results in
	 *                 seconds.
	 * @param value    such that <tt>longTime/d</tt> results in seconds.
	 *
	...
	private void setUpControlComponent() {
		...
		Border titledBorder = new TitledBorder(etchedBorder, "Time Display Control");
	 ...
	 * <p>
	 *
	 * @param e a SourcedTimerEvent containing TimeSource that generated tick.
	 */
	@Override
