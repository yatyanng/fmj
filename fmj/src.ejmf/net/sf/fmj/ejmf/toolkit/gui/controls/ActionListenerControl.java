...
public abstract class ActionListenerControl extends AbstractListenerControl {
	 ...
	 *
	 * @param controller A Controller with which listener is associated.
	 */
	protected ActionListenerControl(Skin skin, Controller controller) throws ClassCastException {
	 ...
	 */
	public void setComponentAndListener(AbstractButton button, ActionListener listener) {
