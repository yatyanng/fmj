...
public interface GainMeter {
	/**
	 * Transform a gain control level value [0.0...1.0] to a value appropriate for
	 * this GainMeter.
	 *
	 * @param level A value returned by getLevel method of a GainControl object.
	 ...
	 *
	 * @param flag If true, GainMeter is muted. Otherwise gain is not muted.
	 */
