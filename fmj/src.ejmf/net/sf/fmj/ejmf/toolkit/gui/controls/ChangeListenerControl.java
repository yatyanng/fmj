...
public abstract class ChangeListenerControl extends AbstractListenerControl {
	...
	protected void addControlListener(EventListener listener) {
		((ProgressSlider) getControlComponent()).addChangeListener((ChangeListener) listener);
	}
	...
	protected void removeControlListener(EventListener listener) {
		((ProgressSlider) getControlComponent()).removeChangeListener((ChangeListener) listener);
	}
	 ...
	 *
	 * @param slider   A ProgressSlider that serves as Control component.
