...
import net.sf.fmj.ejmf.toolkit.gui.controls.ActionListenerControl;
...
import net.sf.fmj.ejmf.toolkit.gui.controls.skins.two.SkinTwo;
...
public class StandardControlPanel extends AbstractControlPanel {
	 ...
	 *
	 * @param p A player with which control panel is associated.
	 ...
	 *
	 * @param p           A player with which control panel is associated.
	 * @param buttonFlags Control values OR'd together which determine the controls
	 *                    that are displayed.
	 * @see javax.media.Player
	 */
	 ...
	 * BasicControlPanel.
	 *
	 * This method may be over-ridden for a wholesale customization of the control
	 * panel.
	 *
	 */
	@Override
	...
	public AbstractButton getFastForwardButton() {
		return (AbstractButton) getControl(StandardControls.FF_CONTROL).getControlComponent();
	}
	...
	public AbstractGainButtonPanel getGainButtonPanel() {
		return (AbstractGainButtonPanel) getControl(StandardControls.GAIN_CONTROL).getControlComponent();
	}
	...
	public AbstractButton getGainMeterButton() {
		return (AbstractButton) getControl(StandardControls.GAINMETER_CONTROL).getControlComponent();
	}
	...
	public AbstractButton getReverseButton() {
		return (AbstractButton) getControl(StandardControls.REVERSE_CONTROL).getControlComponent();
	}
	...
	public AbstractButton getStopButton() {
		return (AbstractButton) getControl(StandardControls.STOP_CONTROL).getControlComponent();
	}

	/**
	 * Set the control button for fast forwarding the player associated with this
	 * control panel.
	 *
	...
	/**
	 * Set the control button for pausing the player associated with this control
	 * panel.
	 *
	 * @param c An AbstractButton
	 */
	...
	/**
	 * Set the control button for reversing the player associated with this control
	 * panel.
	 *
	 * @param c An AbstractButton
	 */
	...
	/**
	 * Set the control button for reversing the player associated with this control
	 * panel. Supply a listener to implement control semantics.
	 *
	 * @param c An AbstractButton
	 * @param l A MouseListener that implements button semantics.
	 */
	...
	/**
	 * Set the control button for starting the player associated with this control
	 * panel.
	 *
	 * @param c An AbstractButton
	 */
	...
	/**
	 * Set the control button for stopping the player associated with this control
	 * panel.
	 *
	 * @param c An AbstractButton
	 */
