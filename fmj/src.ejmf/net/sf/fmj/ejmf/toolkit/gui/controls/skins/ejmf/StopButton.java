...
public class StopButton extends BasicControlButton {
	 ...
	 * @param x         Original translation (x) to point in button where where
	 *                  square is drawn.
	 * @param y         Original translation (y) to point in button where where
	 *                  square is drawn.
	 * @param size      Size of square.
	 * @param isEnabled If true, square is drawn enabled (i.e. black), otherwise,
	 *                  they are offset by (1,1) and drawn with UIManager's
	 *                  controlShadow color.
	 */
	@Override
