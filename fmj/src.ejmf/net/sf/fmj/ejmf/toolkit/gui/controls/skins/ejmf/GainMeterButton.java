...
public class GainMeterButton extends BasicControlButton implements GainMeter {
	...
	/**
	 * Set gain level of gain meter. The input argument is a gain level that gets
	 * mapped to a number of "waves" emanating from front of speaker.
	 *
	 * @param level is a gain level value that gets mapped to a display value
	 */
	@Override
	 ...
	 *
	 * @param muted true to draw button to reflect muted state, false otherwise.
	 */
	@Override
	...
	/**
	 * Redraws GainMeter GUI component as necessary in response to change in gain
	 * value.
	 */
	@Override
