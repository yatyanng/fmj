...
public class ProgressSlider extends Canvas implements ProgressBar {
			...
			public void mouseDragged(MouseEvent e) {
				...
				for (int i = listeners.length - 2; i >= 0; i -= 2)
					if (listeners[i] == ChangeListener.class)
						((ChangeListener) listeners[i + 1]).stateChanged(new ChangeEvent(ProgressSlider.this));
			}
		});
	}
	...
	public Dimension getPreferredSize() {
		return new Dimension(sliderLen + DEFAULT_THUMB_WIDTH + 1, DEFAULT_THUMB_HEIGHT);
	}
	 ...
	 *
	 * @return An integer indicatiing position of thumb within range of legal slider
	 *         values.
	 */
	@Override
	public int getValue() {
	...
	/**
	 * Set the largest value progress slider can take on. When slider reaches this
	 * value operation which progress bar is measuring is complete.
	 *
	...
	/**
	 * Set the smallest value progress slider can take on. When slider value reaches
	 * this value, the operation measured by progress bar has not been started.
	 *
	 ...
	 * Get current value of sprogress bar.
	 *
	 * @param value An integer value within range of legal slider values.
	 */
	@Override
