...
public abstract class AbstractControlPanel extends JPanel {
	 ...
	 *
	 * @param player Player with which control panel is associated.
	 */
	 ...
	 *
	 * @param player Player with which control panel is associated.
	 * @param flags  OR'd value of USE values that determine which control buttons
	 *               are displayed.
	 */
	 ...
	 *
	 * @param flags Is the bit-wise OR of some number of Control identifiers, e.g.
	 *              USE_START_CONTROL. OR'd value of USE values that determine which
	...
	/**
	 * Remove the control component at location <tt>atIndex</tt> with the component
	 * named by <tt>withComponent</tt>.
	 * <p>
	 * If default layout is changed by a subclass, this method may need to be
	 * overridden.
	 *
	...
	/**
	 * Set border of control panel. Subclasses should override this method if they
	 * prefer a border different than EtchedBorder.
	 */
