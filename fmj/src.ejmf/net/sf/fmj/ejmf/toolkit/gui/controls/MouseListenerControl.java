...
public abstract class MouseListenerControl extends AbstractListenerControl {
	 ...
	 *
	 * @param controller A Controller with which control is to be associated.
	 */
	 ...
	 * <p>
	 *
	 * @param listener java.util.EventListener representing control semantics to be
	 *                 added.
	 */
	@Override
	protected void addControlListener(EventListener listener) {
		((AbstractButton) getControlComponent()).addMouseListener((MouseListener) listener);
	}
	...
	protected void removeControlListener(EventListener listener) {
		((AbstractButton) getControlComponent()).removeMouseListener((MouseListener) listener);
	}

	/**
	 * Type-safe way to set Control Component.
	 *
	 * @param button An AbstractButton that acts as control component.
	 */
	 ...
	 *
	 * @param button   An AbstractButton that serves as Control component.
	 * @param listener A ChangeListener that implements Control semantics.
	 */
