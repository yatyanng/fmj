...
public class PauseButton extends BasicIconButton {
	public PauseButton() {
		super(new ImageIcon(StartButton.class.getResource("resources/control_pause_blue.png")),
				new ImageIcon(StartButton.class.getResource("resources/control_pause.png")));
	}
}
