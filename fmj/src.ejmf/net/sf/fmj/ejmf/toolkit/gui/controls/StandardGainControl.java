...
public class StandardGainControl extends AbstractGainControl implements GainChangeListener {
	 ...
	 * Component is a JPanel and buttons need to be extracted from it. Same listener
	 * is posted to both buttons.
	 *
	 * @param listener Listener that implements semantics for gain control.
	 */
	@Override
	 ...
	 * increases gain level by 0.1 for each click of up button and decreases gain
	 * level by 0.1 for each click of down button.
	 *
	...
	/**
	 * Set enable state of gain buttons based on gain level. If level has reached
	 * maximum, disable increase button. If level has reached minimum, enable
	 * descrease button.
	 *
	 ...
	 *
	 * @param listener Listener is removed from listener list associated with this
	 *                 control.
	 */
	@Override
	 ...
	 *
	 * @param bp An AbstractGainButtonPanel that serves as Control component.
	 */
	 ...
	 *
	 * @param bp       An AbstractGainButtonPanel that serves as Control component.
	 * @param listener An ActionListener that implements Control semantics.
	 */
	 ...
	 *
	 * @param listener An ActionListener that implements gain control button
	 *                 semantics.
	 */
	@Override
