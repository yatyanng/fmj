...
public abstract class BasicControlButton extends JButton implements SwingConstants {
	...
	/**
	 * Paint the background and border or button component. Call out to painIcon to
	 * draw icon in button.
	 * <p>
	 * This method takes care of all bevellng, etc depending on whether button is
	 * pressed of enabled/disabled.
	 */
	 ...
	 */
	protected abstract void paintIcon(Graphics g, int x, int y, int size, boolean isEnabled);
