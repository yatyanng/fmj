...
public class StopButton extends BasicIconButton {
	public StopButton() {
		super(new ImageIcon(StartButton.class.getResource("resources/control_stop_blue.png")),
				new ImageIcon(StartButton.class.getResource("resources/control_stop.png")));
	}
