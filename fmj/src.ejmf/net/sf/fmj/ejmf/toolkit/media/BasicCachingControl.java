...
public class BasicCachingControl implements CachingControl {
	...
	/**
	 * Constructs a BasicCachingControl for the given AbstractController. Uses the
	 * length arg to initialize the progress bar.
	 *
	 * @param c      The AbstractController from which CachingControlEvents are
	 *               posted whenever the status of this BasicCachingControl changes.
	 *
	 * @param length The length of the media to be downloaded.
	 */
	public BasicCachingControl(AbstractController c, long length) {
		...
		pauseButton.addActionListener(new ActionListener() {
			/**
			 * Stops and deallocates the AbstractController when the stop button is pushed.
			 */
			@Override
	 ...
	 *
	 * @param toAdd Number of bytes that have been downloaded since the last time
	...
	/**
	 * Get a Component that provides additional download control. Returns null if
	 * only a progress bar is provided.
	 *
	...
	public synchronized void reset(long length) {
		...
		controller.postEvent(new CachingControlEvent(controller, this, progress));
	}
	 ...
	 *
	 * @param progress Number of bytes that have been downloaded.
	 */
	...
	/**
	 * Sets whether the AbstractController is downloading or not. Other methods in
	 * the BasicCachingControl call this method automatically.
	 *
	 * @param isDownloading boolean indicating whether the media is downloading.
	 */
	 ...
	 *
	 * @param isPaused boolean indicating whether the media is paused.
	 */
