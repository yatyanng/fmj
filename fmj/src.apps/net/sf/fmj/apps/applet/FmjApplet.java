...
public class FmjApplet extends PlayerDriver implements ControllerListener {
	...
	public void init() {
		...
		if (!ClasspathChecker.checkManagerImplementation()) { // JMF manager is in charge, we need to wipe out anything
																// in its
																// registry, and register ours.
																// let's get rid of any JMF entries in registry.
			RegistryDefaults
					.unRegisterAll(RegistryDefaults.JMF | RegistryDefaults.FMJ_NATIVE | RegistryDefaults.THIRD_PARTY);
