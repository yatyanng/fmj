...
public class FmjTranscode {
	...
	private static void usage() {
		System.out.println(
				"Usage: FmjTranscode [Input URL] [Output format [Output format...]] [Output MIME type] [Output URL]");
		System.out.println();
		System.out.println(
				"Output URL may be specified as \"render:\", in which case the output is rendered instead of sent to a specific output.");
		System.out.println("In this case, set the output MIME type to: \"raw\"");
		System.out.println();
		System.out.println("Output format syntax:");
		System.out.println(
				"    Audio: [encoding]:[sampleRate]:[sampleSizeInBits]:[channels]:[endian]:[signed]:[frameSizeInBits]:[frameRate]:[dataType]");
		...
		System.out.println(
				"    Example: LINEAR:44100:16:2 corresponds to linear (PCM), 44100.0 khz, 16 bits per sample, stereo.");
		System.out.println(
				"    Example: ULAW/RTP:8000:8:1 corresponds to ULAW/RTP, 8000.0 khz, 8 bits per sample, mono.");
		System.out.println(
				"    Example: LINEAR:22050:8:1:?:S corresponds to linear (PCM), 22050.0 khz, 8 bits per sample, mono, unspecified endianness, signed");
		...
		System.out.println(
				"    Example: PNG:640x480 corresponds to PNG (MPNG), 640x480, with everything else unspecified");
	...
	private void transcode(String inputUrl, Format[] outputFormats, ContentDescriptor outputContentDescriptor,
			String outputUrl) throws Exception {
		final ProcessorModel processorModel = new ProcessorModel(new MediaLocator(inputUrl), outputFormats,
		...
		final KeyboardInputThread keyboardInputThread = new KeyboardInputThread(processor);
