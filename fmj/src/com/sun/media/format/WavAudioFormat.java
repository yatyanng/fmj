...
public class WavAudioFormat extends AudioFormat {
	...
	public static final Hashtable<Integer, String> formatMapper = new Hashtable<Integer, String>();
	public static final Hashtable<String, Integer> reverseFormatMapper = new Hashtable<String, Integer>();
	...
	public WavAudioFormat(String encoding, double sampleRate, int sampleSizeInBits, int channels, int frameSizeInBits,
			int averageBytesPerSecond, byte[] codecSpecificHeader) {
		// averageBytesPerSecond seems to be substituted for frameRate.
		super(encoding, sampleRate, sampleSizeInBits, channels, NOT_SPECIFIED, NOT_SPECIFIED, frameSizeInBits,
	...
	public WavAudioFormat(String encoding, double sampleRate, int sampleSizeInBits, int channels, int frameSizeInBits,
			int averageBytesPerSecond, int endian, int signed, float frameRate, Class<?> dataType,
			byte[] codecSpecificHeader) {
		// averageBytesPerSecond seems to be substituted for frameRate.
		super(encoding, sampleRate, sampleSizeInBits, channels, endian, signed, frameSizeInBits,
				averageBytesPerSecond /* frameRate */, dataType);
		this.averageBytesPerSecond = averageBytesPerSecond;
		this.codecSpecificHeader = codecSpecificHeader;
	...
	@Override
	public Object clone() {
		return new WavAudioFormat(encoding, sampleRate, sampleSizeInBits, channels, frameSizeInBits,
				averageBytesPerSecond, endian, signed, (float) frameRate, dataType, codecSpecificHeader);
	...
	public boolean matches(Format format) {
		...
		return FormatUtils.matches(this.averageBytesPerSecond, oCast.averageBytesPerSecond)
