...
public class AviVideoFormat extends VideoFormat {
	...
	public AviVideoFormat(String encoding, Dimension size, int maxDataLength, Class<?> dataType, float frameRate,
			int planes, int bitsPerPixel, int imageSize, int xPelsPerMeter, int yPelsPerMeter, int clrUsed,
	...
	@Override
	public Object clone() {
		return new AviVideoFormat(encoding, size, maxDataLength, dataType, frameRate, planes, bitsPerPixel, imageSize,
				xPelsPerMeter, yPelsPerMeter, clrUsed, clrImportant, codecSpecificHeader);
	...
	public boolean equals(Object format) {
		...
		return this.planes == oCast.planes && this.bitsPerPixel == oCast.bitsPerPixel
				&& this.imageSize == oCast.imageSize && this.xPelsPerMeter == oCast.xPelsPerMeter
				&& this.yPelsPerMeter == oCast.yPelsPerMeter && this.clrUsed == oCast.clrUsed
				&& this.clrImportant == oCast.clrImportant
				&& FormatUtils.byteArraysEqual(this.codecSpecificHeader, oCast.codecSpecificHeader);
	}
	...
	public String toString() {
		final int extraBytes = codecSpecificHeader == null ? 0 : codecSpecificHeader.length;
