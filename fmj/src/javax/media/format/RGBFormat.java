...
public class RGBFormat extends VideoFormat {
	 ...
	 * @param flipped       Indicates whether or not the lines in the video frame
	 *                      are flipped vertically (upside down).
	 *                      <tt>Format.TRUE</tt> indicates the image is flipped,
	 *                      <tt>Format.FALSE</tt> indicates that it is not.
