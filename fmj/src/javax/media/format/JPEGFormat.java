...
public class JPEGFormat extends VideoFormat {
	...
	public JPEGFormat(java.awt.Dimension size, int maxDataLength, Class<?> dataType, float frameRate, int q, int dec) {
	...
	@Override
	public Object clone() {
		return new JPEGFormat(FormatUtils.clone(size), maxDataLength, dataType, frameRate, qFactor, decimation);
	}
	...
	public boolean equals(Object format) {
		...
		return this.qFactor == oCast.qFactor && this.decimation == oCast.decimation;
	}
