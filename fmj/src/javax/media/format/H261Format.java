...
public class H261Format extends VideoFormat {
	...
	public H261Format(java.awt.Dimension size, int maxDataLength, Class<?> dataType, float frameRate,
	...
	public boolean matches(Format format) {
		...
		final boolean result = FormatUtils.matches(this.stillImageTransmission, oCast.stillImageTransmission);
