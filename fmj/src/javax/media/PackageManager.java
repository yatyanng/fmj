...
public class PackageManager {
	...
	private static synchronized boolean init() {
		...
		try {
			...
			getProtocolPrefixListMethod = getStaticMethodOnImplClass("getProtocolPrefixList", new Class[] {},
					Vector.class);
			setProtocolPrefixListMethod = getStaticMethodOnImplClass("setProtocolPrefixList",
					new Class[] { Vector.class }, void.class);
			commitProtocolPrefixListMethod = getStaticMethodOnImplClass("commitProtocolPrefixList", new Class[] {},
					void.class);
			getContentPrefixListMethod = getStaticMethodOnImplClass("getContentPrefixList", new Class[] {},
					Vector.class);
			setContentPrefixListMethod = getStaticMethodOnImplClass("setContentPrefixList",
					new Class[] { Vector.class }, void.class);
			commitContentPrefixListMethod = getStaticMethodOnImplClass("commitContentPrefixList", new Class[] {},
					void.class);
