...
public class SessionAddress implements java.io.Serializable {
	...
	public SessionAddress(java.net.InetAddress dataAddress, int dataPort, int timeToLive) {
		this(dataAddress, dataPort, dataAddress, dataPort + 1);
		ttl = timeToLive;
	}

	public SessionAddress(java.net.InetAddress dataAddress, int dataPort, java.net.InetAddress controlAddress,
			int controlPort) {
