...
public abstract class RTPManager implements Controls {
	...
	public abstract SendStream createSendStream(DataSource dataSource, int streamIndex)
	...
	public abstract void initialize(SessionAddress[] localAddresses, SourceDescription[] sourceDescription,
			double rtcpBandwidthFraction, double rtcpSenderBandwidthFraction, EncryptionInfo encryptionInfo)
			throws InvalidSessionAddressException, java.io.IOException;
	...
	public abstract void removeTarget(SessionAddress remoteAddress, String reason)
