	...
	private static synchronized boolean init() {
		...
		try {
			...
			if (!(CaptureDeviceManager.class.isAssignableFrom(implClass)))
				throw new Exception(
						"javax.media.cdm.CaptureDeviceManager not subclass of " + CaptureDeviceManager.class.getName());
			getDeviceMethod = getStaticMethodOnImplClass("getDevice", new Class[] { String.class },
					CaptureDeviceInfo.class);
			getDeviceListMethod = getStaticMethodOnImplClass("getDeviceList", new Class[] { Format.class },
					Vector.class);
			addDeviceMethod = getStaticMethodOnImplClass("addDevice", new Class[] { CaptureDeviceInfo.class },
					boolean.class);
			removeDeviceMethod = getStaticMethodOnImplClass("removeDevice", new Class[] { CaptureDeviceInfo.class },
					boolean.class);
