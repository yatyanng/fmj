...
public class Buffer {
	 ...
	 * <tt>Buffer</tt>
	 *
	 * @param buffer The input <tt>Buffer</tt> the copy the attributes from.
	 */
	 ...
	 *
	 * @param data The data object that holds the media data chunk for this
	 ...
	 *
	 * @param discard A boolean value that contains the DISCARD status of the
	 ...
	 *
	 * @param duration The duration for the <tt>Buffer</tt>, in nanoseconds.
	 * @see #duration
	 */
	 ...
	 *
	 * @param eom A boolean value that contains the EOM status of the
	 *            <tt>Buffer</tt>. Set to <tt>true</tt> to enable the EOM flag,
	 *            <tt>false</tt> to disable the flag.
	 * @see #setFlags
	 * @see #FLAG_EOM
	 ...
	 *
	 * @param format The <tt>Format</tt> of the data.
	 */
	 ...
	 *
	 * @param header The header object that holds the media data chunk for this
	 *               <tt>Buffer</tt>.
	 * @see #header
	 */
	 ...
	 * data.
	 *
	 * @param number The sequence number for the <tt>Buffer</tt>.
	 * @see #sequenceNumber
	 */
	 ...
	 *
	 * @param timeStamp The time stamp for the <tt>Buffer</tt>, in nanoseconds.
	 * @see #timeStamp
	 */
