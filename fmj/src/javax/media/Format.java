 ...
 * that meets certain requirements without needing to find an exact match.
 * <p>
...
public class Format implements java.lang.Cloneable, java.io.Serializable {
	 ...
	 *                 or <tt>shortArray</tt>. For example, for a byte array the
	 *                 data type would be " <tt>Format.byteArray</tt>".
	 */
	...
	public boolean equals(Object format) {
		...
		return (dataType == otherType) && (encoding == otherEncoding
				|| ((encoding != null && otherEncoding != null) && isSameEncoding((Format) format)));
	}
	 ...
	 * result.
	 *
	 * @param other The <tt>Format</tt> object to intersect with this
	 *              <tt>Format</tt>.
	...
	public boolean matches(Format format) {
		...
		return (format.encoding == null || encoding == null || isSameEncoding(format))
				...
				&& (clz.isAssignableFrom(format.clz) || format.clz.isAssignableFrom(clz));
	}
