...
public class MediaPlayerBeanInfo extends java.beans.SimpleBeanInfo {
	private static PropertyDescriptor buildPropertyDescriptor(Class<?> clazz, String name, String displayName,
			Class<?> propertyEditorClass, boolean bound) throws IntrospectionException {
	...
	public MediaPlayerBeanInfo() {
		try {
			propertyDescriptors = new PropertyDescriptor[] {
					buildPropertyDescriptor(MediaPlayer.class, "mediaLocation", "media location",
					...
					buildPropertyDescriptor(MediaPlayer.class, "cachingControlVisible", "show caching control", null,
							true),
					...
					buildPropertyDescriptor(MediaPlayer.class, "volumeLevel", "volume",
							javax.media.bean.playerbean.MediaPlayerVolumePropertyEditor.class, true),
	...
	public java.beans.EventSetDescriptor[] getEventSetDescriptors() {
		throw new java.lang.Error(new java.beans.IntrospectionException(
