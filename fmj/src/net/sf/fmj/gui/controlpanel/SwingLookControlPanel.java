...
public class SwingLookControlPanel extends JPanel implements TimeSource, SourcedTimerListener {
	...
	public static final int DEFAULT_FLAGS = USE_PLAY_CONTROL
			| /* USE_STOP_CONTROL | USE_BACK_CONTROL | USE_FORWARD_CONTROL | */USE_NEXT_CONTROL | USE_PREVIOUS_CONTROL
			| USE_POSITION_CONTROL | USE_LENGTH_TEXT | USE_POSITION_TEXT | USE_VOLUME_CONTROL | USE_MUTE_CONTROL;
	...
	private JSlider getPositionSlider() {
		...
		if (positionSlider == null) {
			...
			positionSlider.addChangeListener(new ChangeListener() {
				@Override
				public void stateChanged(ChangeEvent e) { // note: this gets called whether the user updates it, or
					...
					logger.fine("User adjusted position slider to (millis): " + valueMillis + " from "
