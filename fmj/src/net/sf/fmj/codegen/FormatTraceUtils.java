...
public class FormatTraceUtils {
	...
	public static void traceClone(Format f1, Format f2) {
		if (!TRACE)
			return;
		System.out.println(
				"assertEquals(" + MediaCGUtils.formatToStr(f1) + ".clone(), " + MediaCGUtils.formatToStr(f2) + ");");
	...
	public static void traceIntersects(Format f1, Format f2, Format result) {
		if (!TRACE)
			return;
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".intersects("
				+ MediaCGUtils.formatToStr(f2) + "), " + MediaCGUtils.formatToStr(result) + ");");
	...
	public static void traceMatches(Format f1, Format f2, boolean result) {
		if (!TRACE)
			return;
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".matches(" + MediaCGUtils.formatToStr(f2)
				+ "), " + result + ");");
	}
	...
	public static void traceRelax(Format f1, Format result) {
		...
		System.out.println("assertEquals(" + MediaCGUtils.formatToStr(f1) + ".relax(), "
