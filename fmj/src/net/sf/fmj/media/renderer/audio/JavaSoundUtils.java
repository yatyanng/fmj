...
public class JavaSoundUtils {
	...
	public static javax.sound.sampled.AudioFormat convertFormat(AudioFormat format) {
		...
		if (encoding == Encoding.PCM_SIGNED) {
			...
			sampledFormat = new javax.sound.sampled.AudioFormat((float) sampleRate, sampleSize, channels, false,
					endian);
			...
			sampledFormat = new javax.sound.sampled.AudioFormat(encoding, (float) sampleRate, sampleSize, channels,
					frameSize, (float) frameRate, endian);
		}
	...
	public static AudioFormat convertFormat(javax.sound.sampled.AudioFormat format) {
		...
		AudioFormat jmfFormat = new AudioFormat(encodingString, sampleRate, sampleSize, channels, endian, signed,
				frameSize, frameRate, Format.byteArray);
