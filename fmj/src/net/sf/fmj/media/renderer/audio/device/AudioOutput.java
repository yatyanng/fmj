...
public interface AudioOutput {
	/**
	 * Obtains the number of bytes of data that can be written to the device without
	 * blocking.
	 */
	public int bufferAvailable();

	/**
	 * Close the device. Cannot call this close since it clashes InputStream.close
	...
	/**
	 * Return the time as measured from the samples consumed since the device has
	 * opened.
	 */
