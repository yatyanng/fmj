...
public class JPEGRTPRenderer extends AbstractVideoRenderer implements VideoRenderer {
	private class JPEGRTPFrame {
		...
		byte[] jpegHeader = { (byte) 0xff, (byte) 0xd8, // SOI
				(byte) 0xff, (byte) 0xe0, // APP0
				(byte) 0x00, (byte) 0x10, (byte) 0x4a, (byte) 0x46, (byte) 0x49, (byte) 0x46, (byte) 0x00, // JFIF
				...
				(byte) 0x00, (byte) 0x11, (byte) 0x08, (byte) 0x00, (byte) 0x90, // height
				...
				(byte) 0xff, (byte) 0xda, (byte) 0x00, (byte) 0x0c, (byte) 0x03, (byte) 0x01, (byte) 0x00, (byte) 0x02,
	...
	public int doProcess(Buffer buffer) {
		...
		{
			if (TRACE)
				logger.fine("JPEGRTPRenderer: dropping current frame ts=" + currentFrame.timestamp
						+ ", got new packet ts=" + timestamp);
