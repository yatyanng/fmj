...
public class BasicClock implements Clock {
	 ...
	 * @exception ClockStoppedException is thrown if this method is invoked on a
	 *                                  stopped clock.
	 */
	@Override
	 ...
	 * @exception IncompatibleTimeBaseException thrown if clock cannot accept the
	 *                                          given time base.
	 */
	@Override
