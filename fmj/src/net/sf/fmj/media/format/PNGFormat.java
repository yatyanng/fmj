...
public class PNGFormat extends VideoFormat {
	...
	public PNGFormat(java.awt.Dimension size, int maxDataLength, Class<?> dataType, float frameRate) {
	...
	@Override
	public Object clone() {
		return new PNGFormat(FormatUtils.clone(size), maxDataLength, dataType, frameRate);
	}
