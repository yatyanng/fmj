...
public class MPEGMux extends BasicMux {
	...
	public Format setInputFormat(Format input, int trackID) {
		 ...
		 * "Sample rate should be 8000. Cannot handle sample rate " + sampleRate; else
		 * if (format.getFrameSizeInBits() != (33*8)) reason =
		 * "framesize should be 33 bytes"; else if (format.getChannels() != 1) reason =
