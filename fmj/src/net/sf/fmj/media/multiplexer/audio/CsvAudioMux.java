...
public class CsvAudioMux extends AbstractInputStreamMux {
	...
	/**
	 * bit-wise literal. Is in general unsigned, but may be signed if all 32 bits
	 * are used.
	 */
	private static int getSample(byte[] inputBufferData, int byteOffsetOfSample, int inputSampleSizeInBytes,
			int inputEndian) {
		int sample = 0;
	...
	public Format[] getSupportedInputFormats() {
		...
		return new Format[] { new AudioFormat(AudioFormat.LINEAR, -1.0, -1, -1, -1, -1, -1, -1.0, Format.byteArray), };
	}
