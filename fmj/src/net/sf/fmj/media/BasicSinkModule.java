...
public abstract class BasicSinkModule extends BasicModule {
	 ...
	 *               requested media time is set to 100 and the current location is
	 *               set to 90 (the previous key frame where the parser can seek
	 *               to). The parameter <tt>actual</tt> should be set to 90.
	 */
