...
public class MuLawEncoderUtil {
	...
	/**
	 * An array where the index is the 16-bit PCM input, and the value is the mu-law
	 * result.
	 */
	...
	private static byte encode(int pcm) {
		 ...
		 * 0 . . . . . . . We want to find where the first 1 after the sign bit is. We
		 * take the corresponding value from the second row as the exponent value. (i.e.
		 * if first 1 at position 7 -> exponent = 2)
		 */
		int exponent = 7;
		 ...
		 * 0 0 0 1 . . . . . . . . . (meaning exponent is 2) . . . . . . . . . . . . 1 1
		 * 1 1 We shift it 5 times for an exponent of two, meaning we will shift our
	 ...
	 *
	 * @param data   An array of bytes in Little-Endian format
	 * @param target A pre-allocated array to receive the mu-law bytes. This array
	...
	/**
	 * Sets whether or not all-zero bytes are encoded as 2 instead. The pcm values
	 * this concerns are in the range [32768,33924] (unsigned).
	 */
