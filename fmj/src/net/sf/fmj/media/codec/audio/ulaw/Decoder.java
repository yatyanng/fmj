...
public class Decoder extends AbstractCodec {
	...
	public Format[] getSupportedOutputFormats(Format input) {
		if (input == null)
			...
			final AudioFormat result = new AudioFormat(AudioFormat.LINEAR, inputCast.getSampleRate(), 16, 1, endian,
					AudioFormat.SIGNED, 16, inputCast.getFrameRate(), Format.byteArray);
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		final boolean bigEndian = ((AudioFormat) outputFormat).getEndian() == AudioFormat.BIG_ENDIAN; // TODO:
																										...
																										// for
																										// undefined
		MuLawDecoderUtil.muLawDecode(bigEndian, (byte[]) inputBuffer.getData(), inputBuffer.getOffset(),
