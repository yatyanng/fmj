...
public class Encoder extends AbstractCodec {
	...
	public Format[] getSupportedOutputFormats(Format input) {
		if (input == null)
			...
			final AudioFormat result = new AudioFormat(AudioFormat.ULAW, inputCast.getSampleRate(), 8, 1, -1,
					AudioFormat.SIGNED, 8, // endian-ness
											// irrelevant
											// for
											// 8
											// bits
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		MuLawEncoderUtil.muLawEncode(bigEndian, (byte[]) inputBuffer.getData(), inputBuffer.getOffset(),
