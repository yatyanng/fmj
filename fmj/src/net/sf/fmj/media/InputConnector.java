...
public interface InputConnector extends Connector {
	 ...
	 * RuntimeException</li>
	 * <li><b>ProtocolSafe</b> - if buffer is available read the buffer and perform
	 * notify() on the connection.<br>
	...
	/**
	 * Sets the OutputConnector this InputConnector is connected to. This method is
	 * called by the connectTo() method of the OutputConnector.
	 */
