...
public abstract class BasicController implements Controller, Duration
{
    ...
    {
        state = Configured;
        Log.comment(this.getClass().getName()+" "+this.hashCode()
			+" is sending ConfigureCompleteEvent");
    ...
    public synchronized void configure()
    {
        ...
        case Unrealized:
            ...
            configureThread.setName(configureThread.getName() + "[ " + this
                    + " ]" + " ( configureThread)");
            Log.comment(this.getClass().getName()+" "+this.hashCode()
        		+" is starting "+configureThread.getClass().getName()+" "+configureThread.hashCode());
...
class ConfigureWorkThread extends StateTransitionWorkThread
{
    ...
    {
    	Log.comment(controller.getClass().getName() + " "+controller.hashCode() 
    			+" is about to do configure!");
...
class RealizeWorkThread extends StateTransitionWorkThread
{
    ...
    protected boolean process()
    {
    	Log.comment(controller.getClass().getSimpleName()+" "+controller.hashCode()
			+" is about to do realize!");
