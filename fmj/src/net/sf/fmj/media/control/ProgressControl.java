...
public interface ProgressControl extends GroupControl {
	...
	/**
	 * Displays the audio properties such as sampling rate, resolution, compression
	 * type, etc. specific to the incoming audio stream.
	 */
	...
	/**
	 * Displays the video properties such as size, compression type, etc. which are
	 * specific to the incoming video stream.
	 */
