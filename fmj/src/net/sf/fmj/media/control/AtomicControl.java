...
public interface AtomicControl extends Control {
	...
	/**
	 * Returns the control group to which this control belongs, if any. Otherwise it
	 * returns null.
	 */
	...
	/**
	 * Returns true if the control is a read-only control and no value can be set on
	 * it. For example, progress controls that display status information will
	 * mostly be read-only.
	 */
	...
	/**
	 * Set the enabled/disabled state of the control. Can be useful to temporarily
	 * gray out a control due to some constraints.
	 */
	public void setEnabled(boolean enabled);

	/**
	 * <B> Sun specific - </B> Sets the description string for this control. Should
	 * be short since it will be displayed as a tool tip when the mouse hovers over
