...
public interface ModuleListener {
	 ...
	 *
	 * @param blocked is set to true if the data is blocked, false if the data has
	 *                been blocked but have now be released.
	 */
	public void dataBlocked(Module from, boolean blocked);

	/**
	 * This method is called when a format change has occurred and the module has
	...
	/**
	 * This method is called when a module detects frame delay. The number returned
	 * is the # of frames behind detected.
	 */
