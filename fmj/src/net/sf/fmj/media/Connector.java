...
public interface Connector {
	 ...
	 * reading and writing from this connection is done using thread safe monitor.
	 */
	 ...
	 * <i>This method should not really be part of the API, but it is put here in
	 * order to remove implementation dependencies.</i>
	 */
	...
	/**
	 * Sets the circular buffer object of the connection. This method is called only
	 * by the OutputConnector.connectTo() method.<br>
	 * <i>This method should not really be part of the API, but it is put here in
	 * order to remove implementation dependencies.</i>
	 *
	 * @param circularBuffer the circular buffer used by this Connection
	 */
	 ...
	 * Connector connection method call. The connector should delegate this call to
	 * its owning Module.
	 */
	 ...
	 * <i>Perhaps the only way to change the protocol is in the constructor ? </i>
	 *
	 * @param protocol either <i>ProtocolPush, ProtocolSafe</i>
	 */
