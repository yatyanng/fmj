...
public abstract class AbstractPacketizer extends AbstractCodec {
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		System.arraycopy(inputBuffer.getData(), inputBuffer.getOffset(), packetBuffer, bytesInPacketBuffer,
				bytesToCopy);
		...
		final boolean packetComplete = (doNotSpanInputBuffers && inputBuffer.getLength() == 0)
