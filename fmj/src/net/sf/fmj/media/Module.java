 ...
 * <i> getLatency(.) removed since it was not used</i> <center>
 * <h2>data transfer protocols</center></h2> We define four protocols of data
...
public interface Module extends javax.media.Controls {
	 ...
	 * Connectors. This function is needed in case of <b>Push</b> protocol Typical
	 * reaction of the module is to process one frame in the calling thread and
	 * return.
	 *
	 * @param inputConnector the inputConnector of the connection which have
	 *                       received data.
	 */
	 ...
	 * typically constructed in the Module's constructor, but their construction can
	 * be delayed until the Player <b>Realizing</b> state. Returns null if the
	 * string doesn't match any of the Module's InputConnectors.
	 *
	...
	/**
	 * Return an array of strings containing this Module's input connectors names
	 * (both connected and unconnected). If this Module contains no inputs an array
	 ...
	 * typically constructed in the Module's constructor. Returns null if the String
	 * doesn't match any of the Module's OutputConnectors.
	 *
	 * @param connectorName the name of the connector
	...
	/**
	 * Return an array of strings containing this Module's output connectors names
	 * (both connected and unconnected). If this Module contains no outputs an array
	 * of length zero is returned.
	 *
	...
	/**
	 * Each of the outputConnectors of this Module has to be registered with this
	 * function. This method also sets the Module reference of the Connector
	 */
	 ...
	 * A Module should call its Connectors reset method, and then clear its internal
	 * buffers typically by calling the StateTransistor's method dealloc().
	 */
	public void reset();

	/**
	 * Selects a format for the Connector (the default is null). The
	 * <b>setFormat()</b> method is typically called by the Manager as part of the
	 * Connector connection method call. Typically the connector would delegate this
	 ...
	 * events.
	 *
	 * @param listener The listener to which the <tt>Module</tt> will post events.
	 */
	public void setModuleListener(ModuleListener listener);

	/**
	 * sets the name of this Module. Called by the owning Player registerModule()
	 * method
	 */
