...
public class MediaProcessor extends BasicProcessor {
	...
	public MediaProcessor() {
		...
		Log.comment(getClass().getName() + " " + hashCode() + " has created its member " + engine.getClass().getName()
				+ " " + engine.hashCode());
	}
	...
	public Component getVisualComponent() {
		/**
		 * Call the superclass method to ensure that restrictions on player methods are
		 * enforced
		 */
