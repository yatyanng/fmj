...
public interface GraphInspector {
	/**
	 * If this method returns true, the media engine will notify the inspector more
	 * frequently with more details.
	 */
	public boolean detailMode();

	/**
	 * This method is notified when the engine has selected the given codec and has
	 * successfully attempted to set the given input and output formats on it. If
	 * this method returns false, the engine will reject the given codec for use in
	 ...
	 * @return false will cause the engine to reject the given codec for use in the
	 *         final flow graph.
	 */
	public boolean verify(Codec codec, Format input, Format output);

	/**
	 * This method is notified when the engine has selected the given multiplexer
	 * and has successfully attempted to set the given input formats on it. If this
	 * method returns false, the engine will reject the given multiplexer for use in
	 * the final flow graph.
	 *
	 * @param mux    the selected multiplexer.
	 * @param inputs the selected input formats to the multiplexer.
	 * @return <tt>false</tt> will cause the engine to reject the given multiplexer
	 *         for use in the final flow graph.
	 */
	public boolean verify(Multiplexer mux, Format inputs[]);

	/**
	 * This method is notified when the engine has selected the given renderer and
	 * has successfully attempted to set the given input format on it. If this
	 * method returns false, the engine will reject the given renderer for use in
	 * the final flow graph.
	 *
	 * @param renderer the selected renderer.
	 * @param input    the selected input format to the renderer.
	 * @return false will cause the engine to reject the given renderer for use in
	 *         the final flow graph.
	 */
