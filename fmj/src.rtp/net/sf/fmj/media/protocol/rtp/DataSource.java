...
public class DataSource extends BasicPushBufferDataSource implements Streamable, RTPSource {
	 ...
	 * because it allows the flexibility to choose whether to invoke the method at
	 * all.
	 */
	 ...
	 * <p>
	 * Disconnect frees resources used to maintain a connection to the source. If no
	 * resources are in use, disconnect is ignored. Implies a stop, if stop hasn't
	 * already been called.
	 */
	@Override
...
//        }
	 ...
	 *
	 * @param type the runtime type of the control over this instance to be returned
	 * @return a control of the specific runtime {@code type} if such a control is
	 *         provider by this instance; otherwise, {@code null}.
	 */
	@Override
	...
	/**
	 * Obtain the collection of streams that this source manages. The collection of
	 * streams is entirely content dependent. The mime-type of this DataSource
	 * provides the only indication of what streams can be available on this
	 * connection.
	 *
	 ...
	 *
	 * @exception IOException thrown if the source has IO trouble at startup time.
	 */
	@Override
