...
public class RTCPRawReceiver extends PacketFilter implements RTCPPacketParserListener {
	...
	public RTCPRawReceiver(SessionAddress localAddress, SessionAddress remoteAddress, OverallStats stats,
			StreamSynch streamSynch, DatagramSocket controlSocket)
			throws UnknownHostException, IOException, SocketException {
		this.stats = null;
		this.streamSynch = streamSynch;
		this.stats = stats;
		UDPPacketReceiver recv = new UDPPacketReceiver(localAddress.getControlPort(),
				localAddress.getControlHostAddress(), remoteAddress.getControlPort(),
	...
	public void visitSendeReport(RTCPSRPacket rtcpSRPacket) {
		streamSynch.update(rtcpSRPacket.ssrc, rtcpSRPacket.rtptimestamp, rtcpSRPacket.ntptimestampmsw,
