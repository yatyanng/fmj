...
public class BurstMetrics {
	...
	/**
	 * The indicator which determines whether the method {@link #calculate()} is to
	 * be invoked before reading {@link #burstMetrics} i.e. <tt>false</tt> if
	...
	/**
	 * Gets the burst metrics (and packet loss and discard metrics) measured by this
	 * algorithm.
	 *
	 * @return the burst metrics (and packet loss and discard metrics) measured by
	 *         this algorithm as they appear in the VoIP Metrics Report Block i.e.
	...
	/**
	 * Notifies this algorithm that a packet has been received, lost, or discarded.
	 *
