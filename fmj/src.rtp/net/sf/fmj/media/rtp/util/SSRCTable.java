...
public class SSRCTable<T> {
	 ...
	 * </p>
	 *
	 * @param array the array into which the SSRCs associated with <tt>Object</tt>s
	 *              in this <tt>SSRCTable</tt> are to be returned if the
	 *              <tt>length</tt> of <tt>array</tt> is greater than or equal to
	 *              the number of the SSRCs in question
	 * @return the SSRCs associated with <tt>Object</tt>s in this
	 *         <tt>SSRCTable</tt>. If the number of SSRCs is less than or equal to
	 *         the <tt>length</tt> of <tt>array</tt>, the SSRCs are written into
	 *         <tt>array</tt> and <tt>array</tt> is returned. Otherwise, a new array
	 *         is allocated.
	 */
	 ...
	 * </p>
	 *
	 * @param array the array into which the <tt>Object</tt>s associated with SSRCs
	 *              in this <tt>SSRCTable</tt> are to be returned if the
	 *              <tt>length</tt> of <tt>array</tt> is greater than or equal to
	 *              the number of the <tt>Object</tt>s in question
	 * @return the <tt>Object</tt>s associated with SSRCs in this
	 *         <tt>SSRCTable</tt>. If the number of <tt>Object</tt>s is less than or
	 *         equal to the <tt>length</tt> of <tt>array</tt>, the <tt>Object</tt>s
	 *         are written into <tt>array</tt> and <tt>array</tt> is returned.
