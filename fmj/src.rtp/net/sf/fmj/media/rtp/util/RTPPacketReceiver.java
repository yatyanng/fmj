...
public class RTPPacketReceiver implements PacketSource, SourceTransferHandler {
	...
	public void transferData(PushSourceStream sourcestream) {
		...
		/*
		 * If sourcestream is capable of adapting to the PushBufferStream interface, it
		 * may want to provide Buffer properties other than data, length and offset such
		 * as flags.
		 */
		PushBufferStream pbs = (PushBufferStream) sourcestream.getControl(PUSH_BUFFER_STREAM_CLASS_NAME);
