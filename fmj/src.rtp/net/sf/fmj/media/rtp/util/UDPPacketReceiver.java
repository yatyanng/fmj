...
public class UDPPacketReceiver implements PacketSource {
	...
	public UDPPacketReceiver(int localPort, String localAddress, int remotePort, String remoteAddress, int maxsize,
			DatagramSocket localSocket) throws SocketException, UnknownHostException, IOException {
		dataBuf = new byte[1];
	...
	public String sourceString() {
		String s = "UDP Datagram Packet Receiver on port " + sock.getLocalPort() + "on local address "
