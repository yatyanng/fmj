...
public class Com {
	...
	public static final GUID IID_IMediaControl = new GUID(0x56a868b1, 0x0ad4, 0x11ce, 0xb0, 0x3a, 0x00, 0x20, 0xaf,
			0x0b, 0xa7, 0x70);
	// DEFINE_GUID(IID_IVideoWindow,0x56a868b4,0x0ad4,0x11ce,0xb0,0x3a,0x00,0x20,0xaf,0x0b,0xa7,0x70);
	public static final GUID IID_IVideoWindow = new GUID(0x56a868b4, 0x0ad4, 0x11ce, 0xb0, 0x3a, 0x00, 0x20, 0xaf, 0x0b,
			0xa7, 0x70);
	public static final GUID IID_IMediaSeeking = IMediaSeeking.Init_IID(new GUID());
	public static final GUID CLSID_FilterGraph = new GUID(0xe436ebb3, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf,
			0x0b, 0xa7, 0x70);
...
//	#if (_WIN32_WINNT >= 0x0400 ) || defined(_WIN32_DCOM) // DCOM
	public static final int CLSCTX_ALL = (CLSCTX_INPROC_SERVER | CLSCTX_INPROC_HANDLER | CLSCTX_LOCAL_SERVER
