...
public class JavaDecoder extends com.ibm.media.codec.audio.AudioCodec {
	...
	public JavaDecoder() {
		inputFormats = new Format[] {
				new AudioFormat(Constants.SPEEX_RTP, 8000, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED) };
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		supportedOutputFormats = new AudioFormat[] {
				new AudioFormat(AudioFormat.LINEAR, af.getSampleRate(), 16, af.getChannels(), AudioFormat.LITTLE_ENDIAN, // isBigEndian(),
	...
	private void initConverter(AudioFormat inFormat) {
		...
		decoder.init(0, (int) inFormat.getSampleRate(), inFormat.getChannels(), false);
	}
