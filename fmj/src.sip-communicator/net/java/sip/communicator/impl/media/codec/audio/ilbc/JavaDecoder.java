...
public class JavaDecoder extends com.ibm.media.codec.audio.AudioCodec {
	...
	public JavaDecoder() {
		inputFormats = new Format[] {
				new AudioFormat(Constants.ILBC_RTP, 8000, 16, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED) };
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		supportedOutputFormats = new AudioFormat[] {
				new AudioFormat(AudioFormat.LINEAR, af.getSampleRate(), 16, 1, AudioFormat.LITTLE_ENDIAN, // isBigEndian(),
