...
public class RTPDestPanel extends javax.swing.JPanel {
	...
	public void addTrack(int trackNum, boolean audio) {
		...
		comboTTL.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "1", "2", "3", "4", "8", "16", "32", "64", "128", "255" }));
		gridBagConstraints = new java.awt.GridBagConstraints();
	...
	private void initComponents() {
		...
		labelMessage.setText("Enter the session address and port number for each track:");
		gridBagConstraints = new java.awt.GridBagConstraints();
