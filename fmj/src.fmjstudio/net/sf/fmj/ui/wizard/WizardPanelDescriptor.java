...
public class WizardPanelDescriptor {
	...
	/**
	 * Override this class to provide the Object-based identifier of the panel that
	 * the user should traverse to when the Back button is pressed. Note that this
	 * method is only called when the button is actually pressed, so that the panel
	 * can change the previous panel's identifier dynamically at runtime if
	 * necessary. Return null if the button should be disabled.
	 *
	...
	/**
	 * Override this class to provide the Object-based identifier of the panel that
	 * the user should traverse to when the Next button is pressed. Note that this
	 * method is only called when the button is actually pressed, so that the panel
	 * can change the next panel's identifier dynamically at runtime if necessary.
	 * Return null if the button should be disabled. Return FinishIdentfier if the
	 * button text should change to 'Finish' and the dialog should end.
	 *
	 * @return Object-based identifier.
	 */
