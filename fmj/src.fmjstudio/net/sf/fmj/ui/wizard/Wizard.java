...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
	...
	/**
	 * Default constructor. This method creates a new WizardModel object and passes
	...
	void close(int code) {
		...
		if (oldPanelDescriptor != null && code == Wizard.FINISH_RETURN_CODE) {
			if (!oldPanelDescriptor.aboutToHidePanel(WizardPanelDescriptor.FINISH))
	 ...
	 *
	 * @return A boolean indicating whether or not the generated javax.swing.JDialog
	 *         is modal.
	 */
	...
	public void setCurrentPanel(Object id) {
		...
		Object oldId = oldPanelDescriptor != null ? oldPanelDescriptor.getPanelDescriptorIdentifier() : null;
	...
	/**
	 * Convienence method that displays a modal wizard dialog and blocks until the
