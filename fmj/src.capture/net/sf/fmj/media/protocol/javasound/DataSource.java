...
public class DataSource extends PushBufferDataSource implements CaptureDevice {
	...
	public void connect() throws IOException {
		...
		try {
			...
			if (null == jmfAudioFormat) {
				...
				if (audioFormat.getSampleRate() == javax.media.Format.NOT_SPECIFIED) {
					javax.media.format.AudioFormat newAudioFormat = new javax.media.format.AudioFormat(
							audioFormat.getEncoding(), 44100.0f, javax.media.Format.NOT_SPECIFIED,
			...
			buflen = (int) ((javaSoundAudioFormat.getFrameSize() * javaSoundAudioFormat.getSampleRate() * buflenMS)
					/ 1000);
			...
			controls = new Object[] { new JavaSoundFormatControl(), new JavaSoundBufferControl(),
					new JitterBufferControl(), new FPC(), levelControl };
