...
public class DataSource extends PushBufferDataSource implements CaptureDevice, FrameGrabbingControl {
	...
	public static VideoFormat convertCivilFormat(com.lti.civil.VideoFormat civilVideoFormat) {
		...
		return new RGBFormat(new Dimension(civilVideoFormat.getWidth(), civilVideoFormat.getHeight()), -1, byte[].class,
	...
	protected Object[] controls = new Object[] { new CivilFormatControl(), new JitterBufferControl(),
			new VideoFrameRateControl() };
